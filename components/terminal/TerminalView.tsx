            ...
            const terminalActionsBody = (
              <>
                ...
                <div className="flex items-center gap-0.5 flex-shrink-0">
                  {(inWorkspace || (orphanSessionCount && orphanSessionCount >= 2)) && onToggleBroadcast && (
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          variant="secondary"
