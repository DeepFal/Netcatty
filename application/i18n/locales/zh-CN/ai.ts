...
export const zhCNAiMessages: Messages = {
  ...
  'terminal.layer.focusPane': '放大当前面板',
  'terminal.layer.restorePanes': '还原分屏布局',
  'terminal.layer.unfocusPane': '退出聚焦',
  'terminal.layer.focusedPane': '已聚焦',
