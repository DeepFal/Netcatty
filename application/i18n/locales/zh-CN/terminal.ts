...
export const zhCNTerminalMessages: Messages = {
  ...
  'snippets.selection.deleteConfirmTitle': '删除选中的 {count} 个脚本？',
  'snippets.selection.deleteConfirmDesc': '所选脚本将被永久删除，此操作无法撤销。',
  'snippets.selection.deleteSuccess': '已删除 {count} 个所选脚本。',
