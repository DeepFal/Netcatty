...
export const zhCNVaultMessages: Messages = {
  ...
  'sftp.conflict.folderDesc': '目标位置已存在同名文件夹',
  'sftp.conflict.folderMergeHint': '合并会保留仅存在于目标文件夹中的文件和子文件夹。',
  'sftp.conflict.folderReplaceWarning': '替换会删除目标文件夹中所有未出现在源文件夹里的文件和子文件夹，删除的数据无法恢复。',
