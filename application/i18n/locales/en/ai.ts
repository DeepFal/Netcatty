...
export const enAiMessages: Messages = {
  ...
  'ai.cursor.modeCliHint': 'Uses your local `agent login` session and subscription Auto quota. API Key is not used in this mode.',
  ...
  'ai.cursor.cliLoginHint': 'Run `agent login` in a terminal, then click Check.',
