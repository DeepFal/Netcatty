...
export const enTerminalMessages: Messages = {
  ...
  'snippets.selection.deleteConfirmTitle': 'Delete {count} selected scripts?',
  'snippets.selection.deleteConfirmDesc': 'The selected scripts will be permanently deleted. This action cannot be undone.',
  'snippets.selection.deleteSuccess': 'Deleted {count} selected scripts.',
