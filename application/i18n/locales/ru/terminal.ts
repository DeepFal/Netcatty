...
export const ruTerminalMessages: Messages = {
  ...
  'snippets.selection.deleteConfirmTitle': 'Удалить выбранные скрипты ({count})?',
  'snippets.selection.deleteConfirmDesc': 'Выбранные скрипты будут удалены без возможности восстановления.',
  'snippets.selection.deleteSuccess': 'Удалено выбранных скриптов: {count}.',
