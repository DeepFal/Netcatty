...
export const ruVaultMessages: Messages = {
  ...
  'sftp.conflict.folderDesc': 'В месте назначения уже существует папка с таким именем',
  'sftp.conflict.folderMergeHint': 'Объединение сохраняет файлы и подпапки, которые существуют только в папке назначения.',
  'sftp.conflict.folderReplaceWarning': 'Замена удалит все файлы и подпапки в папке назначения, которых нет в исходной папке. Удалённые данные нельзя восстановить.',
