...
export const ruAiMessages: Messages = {
  ...
  'terminal.layer.focusPane': 'Развернуть текущую область',
  'terminal.layer.restorePanes': 'Восстановить разделение',
  'terminal.layer.unfocusPane': 'Выйти из фокуса',
  'terminal.layer.focusedPane': 'В фокусе',
