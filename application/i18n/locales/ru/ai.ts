...
export const ruAiMessages: Messages = {
  ...
  'ai.cursor.modeCliHint': 'Использует локальный `agent login` и квоту подписки Auto. API-ключ в этом режиме не используется.',
  ...
  'ai.cursor.cliLoginHint': 'Выполните `agent login` в терминале, затем нажмите Check.',
