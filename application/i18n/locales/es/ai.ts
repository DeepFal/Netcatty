...
export const esAiMessages: Messages = {
  ...
  'ai.chat.permObserverDesc': 'Solo lectura (Cursor CLI: Ask)',
  'ai.chat.permConfirmDesc': 'Preguntar antes de que Netcatty escriba (Cursor CLI: agent + force)',
  'ai.chat.permAutoDesc': 'Ejecutar libremente (Cursor CLI: agent + force)',
