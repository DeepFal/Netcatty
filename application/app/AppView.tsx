...
export function AppView({ ctx }: { ctx: AppViewContext }) {
  const {
    ...
    handleEndSessionDrag, handleFollowAppTerminalThemeChange, handleHostConnectWithProtocolCheck, handleHotkeyAction, handleKeyboardInteractiveCancel, handleKeyboardInteractiveSubmit, handleLockApp,
